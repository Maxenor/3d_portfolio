    ...
    <>
      ...
      <div className="w-full flex">
        <motion.p
          ...
          className="mt-3 text-secondary text-17[px] max-w-3xl leading-[30px]"
        >
          bla bla bla lalaerjzehfrizhfsdhfoshfouzhfzueohfuzehfzuehfzuehfuze
          zefbhzuefhzuehfzueofh zefiuzehfuizehoruizhrouha
        </motion.p>
      </div>
